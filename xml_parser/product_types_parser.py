...
def safe_list_get(input_list, idx, default):
    try:
...
def parse_product_type(xml_element) -> ProductType:
    return ProductType(identifier=get_element_from(xml_element, "Ref", str),
                       ...
                       suite=get_element_from(xml_element, "Комплект", str),

                       direction_Of_WriteOff_Of_Manufactured_Products=get_element_from(
                           xml_element, "НаправлениеСписанияВыпущеннойПродукции", str),
